...
bool collision_manager::aabb_vs_line(const aligned_bounding_box& a_aabb, const line& a_line)
{
	...
	vector_2 extents_neg_x = vector_2(-a_aabb.get_extents().x, a_aabb.get_extents().y);
...
vector_2 collision_manager::clamp(const vector_2& a_vector_2, const vector_2& a_min, const vector_2& a_max)
{
